...
tf.app.flags.DEFINE_integer('num_classes', 61, '''Total num_classes''')
tf.app.flags.DEFINE_integer('img_width', 32, '''img_width''')
tf.app.flags.DEFINE_integer('img_height', 32, '''img_height''')
...
a random batch''')
tf.app.flags.DEFINE_integer('train_batch_size', 4, '''Train batch size''')
tf.app.flags.DEFINE_integer('validation_batch_size', 4, '''Validation batch size, better to be
...
tf.app.flags.DEFINE_string('ckpt_path', './logs_test_110/model.ckpt-79999', '''Checkpoint
